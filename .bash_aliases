...
alias etd='sudo ip link set enp0s25'
alias etu='sudo ip link set enp0s25'
...
alias pacall='rmcache && sudo php bin/console assetic:dump && sudo php bin/console cache:clear -e dev && sudo php bin/console cache:clear -e prod && sudo php bin/console cache:warmup -e dev && sudo php bin/console cache:warmup -e prod && sudo chmod -R 777 ./var/cache/'
